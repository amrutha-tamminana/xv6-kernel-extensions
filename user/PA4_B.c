...
#define FRAME_LIMIT_4 128
#define NUM_PAGES_4   10
...
#define FRAME_LIMIT_6 128           // match your kernel's MAX_FRAMES
#define NUM_PAGES_6   100
...
#define MAXFRAMES_8   128        // must match kernel/kalloc.c MAXFRAMES
#define EXTRA_8       8         // pages beyond capacity to force evictions
#define TOTAL_PAGES_8 20
